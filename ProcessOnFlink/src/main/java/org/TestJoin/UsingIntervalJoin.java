...
//                .setStartingOffsets(OffsetsInitializer.earliest())
    ...
    static final OutputTag<Tuple2<String, String>> leftLateTag = new OutputTag<Tuple2<String, String>>("side-output"){};
    static final OutputTag<Tuple2<String, String>> rightLateTag = new OutputTag<Tuple2<String, String>>("side-output"){};
